...
To let the browser suite run in CI, add a repository secret `E2E_DATA_ZIP`
pointing at a 5etools data zip (Settings → Secrets and variables → Actions).
Without it that step prints a line and passes; the rest of the job runs either
way.
